  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
        <h3><i class="fa fa-angle-right"></i>Comments Table</h3>
        <div class="row mb">
          <!-- page start-->
              ...
              <table cellpadding="0" cellspacing="0" border="0" class="display table table-bordered" id="hidden-table-info">
                <thead>
                  <tr>
                    ...
                    <th class="hidden-phone">Messaage</th>
					<th>Action</th>
                  </tr>
                </thead>
                <tbody>
                   ...
                   <tr>
					   ...
					   <td>
						<?php echo "
                        <a href='view.php?id=".$row['id']."' class='btn btn-success btn-xs'><i class='fa fa-check'></i></a>
                        <a href='delete.php?id=".$row['id']."' class='btn btn-danger btn-xs'><i class='fa fa-trash'></i></a>
						"?>
                      </td>
                   </tr>
                    <?php
